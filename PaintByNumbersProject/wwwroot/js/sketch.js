...
function SaveImage() {
    alert('This feature has not been finalized.');
    //$('#btnSaveImage').html('Saving...');
    //$('#btnSaveImage').attr('disabled', true);
    //$('#btnCancelImage').attr('disabled', true);

    //const svgEl = document.getElementById("defaultCanvas0");
    ...
    ////const svgBlob = dataURLtoBlob(canvas.toDataURL());
    ...
    //var _url = '/Image/UpdateChangesPaitingImage';
    //$.ajax({
    //    url: _url,
    //    type: 'POST',
    //    data: formData,
    ...
    //        $('#btnCancelImage').hide();
    //        $('#btnPaintImage').show();
    //        alert('The changes were successfully updated SVG2!');
    //    },
